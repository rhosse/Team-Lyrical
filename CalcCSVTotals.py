...
Generate the following statistics using the metadata associated with each
lyric record for all cleaned CSV files A(2).csv to Z(2).csv and Numbers(20).csv.
    ...
    if len(sys.argv) > 1:
        ...
        with open(input_filename, 'r') as csvfileInput:
            ...
            for inputCSV_file in inputCSV_list:
                ...
                with open(inputCSV_file, 'r') as inputCSV:
