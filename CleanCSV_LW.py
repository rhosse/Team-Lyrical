...
1. Remove blank lyric records, including Artist, Year, Song, and Lyrics fields
...
def isInt(s):
    ''' Helper function returns True/False if a string is an integer based on 
        if an exception generated.'''
    try: 
        int(s)
        return True
    except ValueError:
