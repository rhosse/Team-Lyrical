...
def updateDictLyricsRecs(inputDict, rowList, index):
    # INDEX:         0      1    2    3 
    # Read columns Artist,Year,Song,Lyrics            

    key = rowList[index]
    if key in inputDict:
        inputDict[key].append([rowList[0],rowList[2],rowList[3]])
    else:
        inputDict[key] = [[rowList[0],rowList[2],rowList[3]]]
    return inputDict
                    ...
                    try:
                        ...
                        for row in inputCSVrows:
                            ...
                            try:
                                ...
                                updateDict(SongYearDict, rowList, 1)
#                                updateDictLyricsRecs(SongYearLyrics, rowList, 1)
